...
export class Pockets {
    ...
    create() {
        ...
        this.itemsTotal = [
            ...
            {
                itemName: "Mask1",
                itemGlobalVar: "HasMask1",
                itemGlobalVarBool: "Mask1InPocket",
                itemInHand: "Mask1InHand",
                itemImage: "Mask1",
            },
            {
                itemName: "Mask2",
                itemGlobalVar: "HasMask2",
                itemGlobalVarBool: "Mask2InPocket",
                itemInHand: "Mask2InHand",
                itemImage: "Mask2",
            },
            {
                itemName: "Mask3",
                itemGlobalVar: "HasMask3",
                itemGlobalVarBool: "Mask3InPocket",
                itemInHand: "Mask3InHand",
                itemImage: "Mask3",
            },
            {
                itemName: "Mask4",
                itemGlobalVar: "HasMask4",
                itemGlobalVarBool: "Mask4InPocket",
                itemInHand: "Mask4InHand",
                itemImage: "Mask4",
            },
        ];
